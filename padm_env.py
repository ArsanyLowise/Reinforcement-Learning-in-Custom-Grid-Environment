...
class TreasureHunt(gym.Env):
    def __init__(self, grid_size=5, seed=None, goal_coordinates=(2, 4), 
                 hell_state_coordinates=[(3, 4),(0,1)], num_obstacles=3, num_treasures=2) -> None:
...
# Function to train using Q-learning (dummy implementation)
def train_q_learning(env, no_episodes, epsilon, epsilon_min, epsilon_decay, alpha, gamma):
    print("Training with Q-learning... (dummy implementation)")

# Function to visualize Q-table (dummy implementation)
def visualize_q_table(hell_state_coordinates, goal_coordinates, actions, q_values_path):
    print("Visualizing Q-table... (dummy implementation)")
